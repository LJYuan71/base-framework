...
<html lang="zh-CN">
<head>
<title>SEC_CLASSIFY_ORG编辑页面</title>
<script>
   	$(function(){
		...
		function showResponse(responseText, statusText){
			...
			if (json.result == 1) {
				...
				Modal.confirm({msg: json.message+"，是否继续编辑？"}).on( function (e) {
				  	if(e){
				  		//继续编辑
				  		window.location.href="${ctx}/platform/permissions/classifyorg/edit.do?id=${classifyOrg.id }";
				  	}else{
				  		//不继续编辑，返回列表页
			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					<div class="ibox-content" style="display: block;">
						<form class="form-horizontal" method="post" id="classifyOrgForm" action="${ctx }/platform/permissions/classifyorg/save.do">
