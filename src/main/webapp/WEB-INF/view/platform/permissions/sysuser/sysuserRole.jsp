...
<script type="text/javascript">
	$(function(){
		...
		$("#submit").click(function(){
		    ...
		    $.ajax({
		        type:"POST",
		        async:false,
		        url: "${ctx}/platform/permissions/sysuserrole/saveUserRole.do?userid="+'${userid}'+"&ids="+selectIds,    
	...
	function setSelectNode(){
    	 $.ajax({   
           type: 'POST',   
           async:false,
           url: "${ctx}/platform/permissions/sysuserrole/getByUserId.do?userid="+'${userid}',//请求的action路径    
           success:function(data){ //请求成功后处理函数。 
           		var ret=eval("("+data+")");
