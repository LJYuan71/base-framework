...
<script>
   ...
   $(function(){
		...
		$.ajax({   
           type: 'POST',   
           async:false,
           url: "${ctx}/platform/permissions/classifyinfo/queryTreeJson.do",//请求的action路径    
   ...
   function getSelectNodes() {
		...
		$.ajax({   
        	type: 'POST',   
          	async:false,
           	url: "${ctx}/platform/permissions/classifyinfo/queryMaxSnByParentid.do?parentid="+selectIds.join(","),//请求的action路径    
           	success:function(data){ //请求成功后处理函数。 
           		var ret=eval("("+data+")");
           		$("#sn").val(ret);
           	}   
			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					<div class="ibox-content" style="display: block;">
						...
						<form class="form-horizontal" method="post" id="classifyInfoForm" action="${ctx}/platform/permissions/classifyinfo/save.do">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input class="form-control" type="text"  name="parentname" id="parentname" value="${classifyInfo.parentname }" readonly="readonly" datatype="*" nullmsg="上级节点必填！">
