		...
		$(".J_menuTab").each(
				function() {
					if ($(this).data("id") == o) {
						...
						//刷新iframe窗体框架中的内容
						document.getElementById('iframe'+m).contentWindow.location.reload(true);
						k = false;
						return false
					}
				});
		if (k) {
			var p = '<a href="javascript:;" class="active J_menuTab" name="'+l+'" data-id="'
					+ o + '">' + l + ' <i class="fa fa-times-circle"></i></a>';
			$(".J_menuTab").removeClass("active");
			var n = '<iframe class="J_iframe" id="iframe' + m
					+ '"name="iframe' + m
