...
(function(d, f, b) {
	...
	a.util = {
			...
			o.find("[datatype]").each(
							function() {								
								if (l == 2) {
									...
									if (l == 3 || l == 4) {
										var getLevel = d(this).parent().prev();
										if(!getLevel.is("label")){
											getLevel = d(this).parent().parent().prev();
										}
										
										if (getLevel.find(
										".Validform_required").length == 0) {
											var content = getLevel.text();
											getLevel.html("<span class='Validform_required'>*</span><span>"+content+"</span>");
											/**/
										}								
									}
								}
		...
		showmsg : function(n, l, m, k) {			
			...
			if ((l == 3 || l == 4) && m.obj) {				
				if(m.type != 2){					
					var checktip = m.obj.parent();										
					if (checktip.find(
					".Validform_checktip").length == 0) {
						checktip.append(
						"<div class='info-control'>" +
						"<span class='Validform_checktip'>"+n+"</span>" +
						"<span class='info-control-horn'><s class='horn2'>&#9670;</s><s class='horn1'>&#9670;</s></span>" +
						"</div>");
					}
				}
				else{
