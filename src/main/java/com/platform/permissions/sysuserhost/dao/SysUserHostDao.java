package com.platform.permissions.sysuserhost.dao;
...
import com.platform.permissions.sysuserhost.mapper.SysUserHostMapper;
import com.platform.permissions.sysuserhost.model.SysUserHost;
@Repository
public class SysUserHostDao{
	@Resource
	private SysUserHostMapper mapper;
	...
	public SysUserHost getById(Long id) {
		return (SysUserHost) mapper.getById(id);
	}
	/**
	 * 根据id删除
	 */
	...
	public Pager<SysUserHost> queryAll(QueryFilter queryFilter) {
		Pager<SysUserHost> returnPager=new Pager<SysUserHost>();
		List<SysUserHost> list=null;
